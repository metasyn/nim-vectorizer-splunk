...
/* Command for C compiler:
   clang -c  -w -O3  -I/Users/aljohnson/.choosenim/toolchains/nim-0.18.0/lib -o /Users/aljohnson/code/nim-splunk-vectorizer/src/nimcache/stdlib_lexbase.o /Users/aljohnson/code/nim-splunk-vectorizer/src/nimcache/stdlib_lexbase.c */
...
N_LIB_PRIVATE N_NIMCALL(void, fillBuffer_QbedUCk2XwI9c7bbRzXBY0g)(tyObject_BaseLexer_B6cGbTPhMsqMovc9cOcIHRw* L) {
	...
	toCopy = (NI)((NI)((*L).bufLen - (*L).sentinel) - ((NI) 1));
	{
		...
		moveMem_E1xtACub5WcDa3vbrIXbwglexbase(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)((*L).sentinel + ((NI) 1))]))), ((NI) ((NI)(toCopy * ((NI) 1)))));
	}
	LA3_: ;
	T5_ = (NI)0;
